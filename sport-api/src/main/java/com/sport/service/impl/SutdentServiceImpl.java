...
//        PageInfo<StudentEntity> pageInfo =
        PageInfo<StudentEntity> pageInfo = PageHelper.startPage(pageStart, pageSize,false).doSelectPageInfo(new ISelect() {
            @Override
...
//        PageInfo<StudentEntity> pageInfo = PageHelper.startPage(pageStart, pageSize).doSelectPageInfo(()->studentDao.selectAll(entityCondition));
