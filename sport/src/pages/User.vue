        ...
        <el-table :data="tableData" style="width: 100%">
            <el-table-column label="姓名" align="center">
                <template slot-scope="scope">
                    <ek-popover trigger="hover" placement="top">
...
//点击查询
  let handleQuery = function () {
    ...
    if(this.filtersForm.code != undefined){
        params.code = this.filtersForm.code
    }

    if(this.filtersForm.name != undefined){
        params.name = this.filtersForm.name
    }

    this.$api.post(this.GLOBAL.httpRequestUrl + '/user/getAllByPage',params,response=>{
